...
#ifndef __IPPAIRDPORT_QUEUE_H__
#define __IPPAIRDPORT_QUEUE_H__

#include "suricata-common.h"
#include "ippairdport.h"

/** Spinlocks or Mutex for the ippairdport queues. */
//#define HQLOCK_SPIN
#define HQLOCK_MUTEX
...
/* Define a queue for storing ippairdports */
typedef struct IPPairDPortQueue_
{
    IPPairDPort *top;
    IPPairDPort *bot;
    uint32_t len;
...
IPPairDPortQueue *IPPairDPortQueueInit(IPPairDPortQueue *);
void IPPairDPortQueueDestroy (IPPairDPortQueue *);

void IPPairDPortEnqueue (IPPairDPortQueue *, IPPairDPort *);
IPPairDPort *IPPairDPortDequeue (IPPairDPortQueue *);
uint32_t IPPairDPortQueueLen(IPPairDPortQueue *);

#endif /* __IPPAIRDPORT_QUEUE_H__ */
